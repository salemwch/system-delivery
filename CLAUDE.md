...
**Everything green:** `pnpm build` → ok · `pnpm test` → 1051/1051 (902 api + 39 track + 33 merchant + 77 web) · MFA sign-in verified end to end · `pnpm lint` → 0 · `pnpm lint:rules` → 6/6 · `pnpm knip` → 0 · `pnpm sast` → 0 (339 targets, all four apps tracked and covered).
