...
**Everything green:** `pnpm build` → ok · `pnpm test` → 638/638 · `pnpm lint` → 0 · `pnpm knip` → 0 · `pnpm sast` → 0.
...
| Migrations     | 0000–0024 applied. Forward-only, checksum-locked, immutable. See individual migration files for DDL details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
