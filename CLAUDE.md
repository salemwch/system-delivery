...
**Everything green:** `pnpm build` → ok · `pnpm test` → 589/589 · `pnpm lint` → 0 · `pnpm knip` → 0 · `pnpm sast` → 0.
...
| Migrations     | 0000–0022 applied. Forward-only, checksum-locked, immutable. See individual migration files for DDL details                                                                                                                                                                                                                                                             |
