...
**Everything green:** `pnpm build` → ok · `pnpm test` → 967/967 (890 api + 30 track + 17 merchant + 30 web) · `pnpm lint` → 0 · `pnpm lint:rules` → 6/6 · `pnpm knip` → 0 · `pnpm sast` → 0 (308 targets, `apps/web` now tracked and covered).
