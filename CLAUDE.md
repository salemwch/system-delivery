...
**Everything green:** `pnpm build` → ok · `pnpm test` → 1246/1246 (1087 api + 39 track + 33 merchant + 87 web) · MFA sign-in verified end to end · `pnpm lint` → 0 · `pnpm lint:rules` → 6/6 · `pnpm knip` → 0 · `pnpm sast` → 0 (355 targets, all four apps tracked and covered).
...
| Migrations     | 0000–0038 applied. Forward-only, checksum-locked, immutable. See individual migration files for DDL details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
